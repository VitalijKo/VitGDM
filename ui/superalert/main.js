const SuperAlert = {
    ...
    alert: function({
        ...
        if (status == '' || status == 'success') {
            ...
            confirmbtn == true ?
                alert_footer.innerHTML = `
                 <span class="accept" title="Download">
                  Download
                </span>
                <span class="close" title="Cancel">
                  Cancel
                </span>
                 ` :
                alert_footer.innerHTML = `
               ...
               Ok
                 ...
                 `;
            alert_heading.style = 'background: linear-gradient(80deg, #FC5D14, #FFB818);';
            document.querySelector('.alert_details > h2').style.color = '#FC5D14';
        }

        if (code == 0)
            document.querySelector('.app-content-headerText').innerHTML = 'VitGDM';
